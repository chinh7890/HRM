...
if (isset($_GET['listcolumn'])) {
       ...
       $column_sorted = array(
              "tb_employee.employee_code", "tb_employee.photo", "tb_employee.last_name", "tb_employee.first_name", "tb_employee.english_name", "tb_employee.gender", "tb_employee.marital_status", "tb_employee.military_service", "tb_employee.date_of_birth",
       ...
       //Tìm $searchTerms trong $list_column và thay bằng ''
       $columData = str_replace($searchTerms, '', $list_column);
       //Tạo mảng các tên cột
       $columnname = array(
              "Employee Code", "Photo", "Last Name", "First Name", "English Name", "Gender", "Marital Status", "Military Service", "Date of Birth",
       ...
       //đưa về mảng có nội dung key ($column_sorted) và value ($columnname)
...
//======================================NẾU CHỌN EXPORT THEO MẪU=====================================================================
// else if (isset($_GET['checkdefault'])) {
//        // Truy vấn dữ liệu từ MySQL
//        $sql = $sql = "SELECT
...
//        $column_data = array(
//               "employee_code", "photo", "last_name", "first_name", "english_name", "gender", "marital_status", "military_service", "date_of_birth",
//               "national_name", "phone_number", "pass_number", "date_of_issue", "place_of_issue",
//               "date_of_expiry", "cccd_number", "date_of_issue_cccd", "place_of_issue_cccd",
//               "place_of_residence", "permanent_address", "health_checkup_date", "job_title_name", "position_name",
//               "job_category_name", "team_name", "level_name", "start_date", "type_contract_name", "contract_duration",
//               "email", "country_name", "location_name"
//        );
//        $row = 2; // Ví dụ: Dòng bắt đầu điền dữ liệu là dòng 2
//        while ($row_data = $result->fetch_assoc()) {
...
//                      if ($a = $b) {
//                             $Photo_path = "../assets/files/" . $row_data['employee_code'] . "/Photo/" . $row_data['photo'];
